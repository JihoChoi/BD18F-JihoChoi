...
Example command for running this script:
    python rnn_tf.py --ps_hosts=localhost:12345 --worker_hosts=localhost:12346,localhost:12347,localhost:12348 --job_name=ps --task_index=0 --max_steps=500
    python rnn_tf.py --ps_hosts=localhost:12345 --worker_hosts=localhost:12346,localhost:12347,localhost:12348 --job_name=worker --task_index=0 --max_steps=500
    python rnn_tf.py --ps_hosts=localhost:12345 --worker_hosts=localhost:12346,localhost:12347,localhost:12348 --job_name=worker --task_index=1 --max_steps=500
    python rnn_tf.py --ps_hosts=localhost:12345 --worker_hosts=localhost:12346,localhost:12347,localhost:12348 --job_name=worker --task_index=2 --max_steps=500
...
def rnn(only_logits=False):
    ...
    # labels_ph = tf.placeholder(tf.int64, shape=[None, num_classes])
    labels_ph = tf.placeholder(tf.int64, [None, num_classes])                             # input y
